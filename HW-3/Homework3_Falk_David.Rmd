...
```{r}
#scatterplot with best fit line for VVIQ by true recall proportion here
```
  
```{r}
#scatterplot with best fit line for VVIQ by false recall proportion here
```
...
```{r}
#falserecall_resid_bestfit
```

  
For each best fit line, create a residuals plot.
```{r}
#residuals plot for VVIQ by true recall proportion best fit line here
```
  
```{r}
#residuals plot for VVIQ by false recall proportion best fit line here
```
